...
var _constants = require("react-reconciler/constants.js");
...
const reconciler = (0, _reactReconciler.default)(HostConfig);
const ReactAseprite = {
  render(element) {
    const rootElement = {
      mino: "meep"
...
function cloneInstance(instance, updatePayload, type, oldProps, newProps, internalInstanceHandle, keepChildren, recyclableInstance) {
  console.log("cloneInstance", instance, updatePayload, type, oldProps, newProps);
}
...
// }
var _default = exports.default = ReactAseprite;